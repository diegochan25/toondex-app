...
from sqlalchemy import UUID as SQLUUID, Date, DateTime, Enum, ForeignKey, Index, String, Text, func
...
class UserSettings(Base):
    ...
    theme: Mapped[AppTheme] = mapped_column(Enum(AppTheme), default=AppTheme.System)
